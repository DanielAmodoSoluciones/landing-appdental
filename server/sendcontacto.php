...
if(!empty($_SERVER['HTTP_X_REQUESTED_WITH']) && strtolower($_SERVER['HTTP_X_REQUESTED_WITH']) == 'xmlhttprequest') {
  ...
  $nombreyapellidos         = $_POST['exampleInputname'];
  $email                    = $_POST['exampleInputEmail1'];
  $comunidaddepropietarios  = $_POST['exampleInputcomunidad'];
  $asunto                   = $_POST['exampleInputasunto'];
  $mensaje                  = $_POST['exampleFormControlTextarea1'];
