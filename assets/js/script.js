...
(function() {
    ...
    var SaaSio = {
        ...
        Basic: {
            ...
            DiaTrabSlider: function() {
                $('.trabajo-slider').owlCarousel({
                    margin: 0,
                    responsiveClass: true,
                    nav: true,
                    dots: false,
    ...
    -----------------------------*/
        ...
        $('.dia-mobile_menu_content .dia-mobile-main-navigation .navbar-nav li a').on("click", function() {
            $('.dia-mobile_menu_wrap').removeClass("mobile_menu_on");
